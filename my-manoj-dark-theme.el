...
;                          :weight bold ))))
 ...
 '(git-gutter-fr:added ((t (:background "grey30" :foreground "green"))))
 '(git-gutter-fr:modified ((t (:background "grey30" :foreground "yellow"))))
 '(git-gutter-fr:deleted ((t (:background "grey30" :foreground "white"))))
